                   ...
                   DIS::EntityStatePdu& enemy)
{
   ...
   /// entity id data
   {
      ...
      DIS::SimulationAddress enemy_sim_addr;

      enemy_sim_addr.setSite( 0 );
      enemy_sim_addr.setApplication( 1 );

      enemy_entity_id.setSimulationAddress( enemy_sim_addr );
      ...
      DIS::SimulationAddress friendly_entity_addr[2];

      friendly_entity_addr[0].setSite( 0 );
      friendly_entity_addr[0].setApplication( 1 );

      friendly_entity_id[0].setSimulationAddress( friendly_entity_addr[0] );

      friendly_entity_id[0].setEntityNumber( 2 );

      friendly0.setEntityID( friendly_entity_id[0] );

      friendly_entity_addr[1].setSite( 0 );
      friendly_entity_addr[1].setApplication( 1 );
      friendly_entity_id[1].setSimulationAddress( friendly_entity_addr[1] );
