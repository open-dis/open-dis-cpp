...
LayerHeader& IFFPdu::getLayerHeader() { return _layerHeader; }

const LayerHeader& IFFPdu::getLayerHeader() const { return _layerHeader; }

void IFFPdu::setLayerHeader(const LayerHeader& pX) { _layerHeader = pX; }

BeamData& IFFPdu::getBeamData() { return _beamData; }

const BeamData& IFFPdu::getBeamData() const { return _beamData; }

void IFFPdu::setBeamData(const BeamData& pX) { _beamData = pX; }
...
const std::vector<IFFFundamentalParameterData>& IFFPdu::getIFFParameters()
    const {
  return _iffParameters;
}

void IFFPdu::setIFFParameters(
